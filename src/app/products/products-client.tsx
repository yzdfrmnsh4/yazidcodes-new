    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-4 items-center justify-between mb-12 p-3 md:p-4 liquid-glass border border-[var(--color-border-specular)] rounded-3xl shadow-xl shadow-black/5 relative z-10 transition-all">
        ...
        <div className="relative w-full lg:max-w-md">
          ...
          <input
            ...
            className="w-full bg-[var(--color-surface-container)] border border-[var(--color-border-specular)] rounded-2xl pl-11 pr-4 py-3 text-sm text-[var(--color-on-surface)] placeholder-[var(--color-text-muted)]/50 focus:outline-none focus:border-secondary transition-all"
          />
        </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-semibold cursor-pointer transition-all ${
                productsCategory === cat
                  ? 'btn-active-tactile font-semibold shadow-lg shadow-secondary/10 text-[var(--color-on-surface)]'
      ...
      {filteredProducts.length > 0 ? (
        ...
        <div className="text-center py-24 glass-card rounded-[3rem] border border-[var(--color-border-specular)] p-12">
          ...
          <h3 className="text-xl font-semibold text-[var(--color-on-surface)] mb-2 font-headline">Aset Tidak Ditemukan</h3>
